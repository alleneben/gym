...
const Field = ({ label,id,type,placeholder,fieldtype,onchange,value,required,hidden,styles,cstyles,cb,disabled}) => {
    ...
    return(
        <div className={styles.formitem}>
            ...
            {
                fieldtype === 'tt' ?
                    <input id={id} name={id} type={ type } placeholder={ placeholder } onChange={onchange} value={value} required={required} hidden={hidden} style={cstyles} disabled={disabled}/> 
                    : fieldtype === 'ta' ?
                    <textarea id={id} name={id} type={ type } placeholder={ placeholder } onChange={onchange} value={value} required={required} style={cstyles}/>
                    :
                    <>
                    <select placeholder={ placeholder } onMouseDown={(e)=>onmousedown(e)} onChange={onchange}>
