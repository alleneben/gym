...
const Details = () => {
    ...
    const { onChange, val, handleSubmit, submitting,invalid, opacity } = useForm({s:'controller',a:'save',d:'payment_fn',data:data,m:'l',c:'gym'},validateform,submitdata,{type:'payment',action:'payment'})
